class Doughnut extends React.Component {
    ...
    renderChart = () => {
        ...
        if (page === "comparison") {
            ...
            chartLabels = [label];
            chartData = [page === "google" ? googleLeads : page == "referral" ? referralLeads : page == "cplead" ? cpleadLeads : page == "socials" ? socialsLeads : facebookLeads];
        ...
        const ctx = document.getElementById('leadsDoughnut')?.getContext('2d');
        if (ctx) {
            ...
            <>
                ...
                {!this.state.hasLeads && (
                    <div style={{ display: 'flex', justifyContent: "center", width: "100%" }}>
                        <p style={{ fontSize: "25px", fontWeight: 600, color: "rgb(100, 181, 246)", position: 'relative', left: 240 }}>
                            No Leads to display
                        </p>
                    </div>
                )}
